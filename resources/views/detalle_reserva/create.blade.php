            ...
            <div class="card shadow-lg border-0">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="mb-0">Agregar Detalle a Reserva</h3>
                        <a href="{{ route('detalle-reserva.index') }}" class="btn btn-light">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('detalle-reserva.store') }}" id="detalleForm">
                        @csrf

                        <div class="form-group row">
                            <label for="reserva_id" class="col-md-4 col-form-label text-md-right">Reserva</label>
                            <div class="col-md-6">
